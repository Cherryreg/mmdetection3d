...
def main():
    ...
    for idx in range(len(train_scan_names)):
        ...
        # print(f'{train_filenames} sample_idx: {scan_name_npz}')
        info = dict()
        ...
        # unaligned_box_label = np.load("/data1/szh/fcaf3d_18_1207/scannet_instance_data/scene0000_00_unaligned_bbox.npy")
        ...
        # axis_align_matrix = np.load("/data1/szh/fcaf3d_18_1207/scannet_instance_data/scene0000_00_axis_align_matrix.npy")
        # annotations['axis_align_matrix'] = axis_align_matrix  # 4x4
        annotations['axis_align_matrix'] = np.eye(4)
        info['annos'] = annotations
        infos_train.append(info)
    mmcv.dump(infos_train, '/data1/szh/mmdet_toscannet/toscannet_infos_train.pkl', 'pkl')
    ...
    for idx in range(len(val_scan_names)):
        ...
        #     "/data1/szh/fcaf3d_18_1207/scannet_instance_data/scene0000_00_axis_align_matrix.npy")
        annotations['axis_align_matrix'] = np.eye(4)
        info['annos'] = annotations
        infos_val.append(info)
    mmcv.dump(infos_val, '/data1/szh/mmdet_toscannet/toscannet_infos_val.pkl', 'pkl')
    ...
    mmcv.dump(infos_test, '/data1/szh/mmdet_toscannet/toscannet_infos_test.pkl', 'pkl')
